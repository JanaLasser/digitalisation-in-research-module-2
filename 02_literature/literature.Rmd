...
* Topic 1:  [ResearchRabbit](https://researchrabbit.ai)
      ...
      * Set an alert if collection is relevant
      
* Topic 2: [Elicit](www.elicit.org): Explore all steps with a question of your interest

* If you know these - implement the [workflow](#workflow): 
  * Find a highly cited paper on [Google Scholar](https://scholar.google.com/) or a specific paper on [Elicit](www.elicit.org)
  * Add to Zotero collection, and sync with ResearchRabbit
