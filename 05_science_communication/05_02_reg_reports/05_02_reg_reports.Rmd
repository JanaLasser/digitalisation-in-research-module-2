...
subtitle: "New publishing practices for transparency & reproducibility: Registered & Exploratory Reports"
...
* On : check if the journals relevant for your research accept pre-registrations

* In the list of journals that accept registered reports, check for journals in your discipline. 
